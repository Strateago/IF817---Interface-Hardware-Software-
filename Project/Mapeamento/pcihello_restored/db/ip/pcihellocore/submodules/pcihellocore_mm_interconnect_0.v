...
module pcihellocore_mm_interconnect_0 (
	...
	wire  [113:0] led_g_s1_agent_rf_source_data;                                          // Led_G_s1_agent:rf_source_data -> Led_G_s1_agent_rsp_fifo:in_data
	...
	wire  [113:0] led_g_s1_agent_rsp_fifo_out_data;                                       // Led_G_s1_agent_rsp_fifo:out_data -> Led_G_s1_agent:rf_sink_data
	...
	wire  [113:0] led_r_s1_agent_rf_source_data;                                          // Led_R_s1_agent:rf_source_data -> Led_R_s1_agent_rsp_fifo:in_data
	...
	wire  [113:0] led_r_s1_agent_rsp_fifo_out_data;                                       // Led_R_s1_agent_rsp_fifo:out_data -> Led_R_s1_agent:rf_sink_data
	...
	wire          hex_display_s1_agent_rp_valid;                                          // hex_display_s1_agent:rp_valid -> router_003:sink_valid
	wire  [112:0] hex_display_s1_agent_rp_data;                                           // hex_display_s1_agent:rp_data -> router_003:sink_data
	wire          hex_display_s1_agent_rp_ready;                                          // router_003:sink_ready -> hex_display_s1_agent:rp_ready
	wire          hex_display_s1_agent_rp_startofpacket;                                  // hex_display_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          hex_display_s1_agent_rp_endofpacket;                                    // hex_display_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	wire          buttons_s1_agent_rp_valid;                                              // buttons_s1_agent:rp_valid -> router_004:sink_valid
	wire  [112:0] buttons_s1_agent_rp_data;                                               // buttons_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [112:0] led_g_s1_agent_rp_data;                                                 // Led_G_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [112:0] led_r_s1_agent_rp_data;                                                 // Led_R_s1_agent:rp_data -> router_006:sink_data
	...
	wire          hexport_s1_agent_rp_valid;                                              // hexport_s1_agent:rp_valid -> router_007:sink_valid
	wire  [112:0] hexport_s1_agent_rp_data;                                               // hexport_s1_agent:rp_data -> router_007:sink_data
	wire          hexport_s1_agent_rp_ready;                                              // router_007:sink_ready -> hexport_s1_agent:rp_ready
	wire          hexport_s1_agent_rp_startofpacket;                                      // hexport_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          hexport_s1_agent_rp_endofpacket;                                        // hexport_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [112:0] led_g_s1_burst_adapter_source0_data;                                    // Led_G_s1_burst_adapter:source0_data -> Led_G_s1_agent:cp_data
	wire          led_g_s1_burst_adapter_source0_ready;                                   // Led_G_s1_agent:cp_ready -> Led_G_s1_burst_adapter:source0_ready
	wire    [7:0] led_g_s1_burst_adapter_source0_channel;                                 // Led_G_s1_burst_adapter:source0_channel -> Led_G_s1_agent:cp_channel
	...
	wire  [112:0] led_r_s1_burst_adapter_source0_data;                                    // Led_R_s1_burst_adapter:source0_data -> Led_R_s1_agent:cp_data
	wire          led_r_s1_burst_adapter_source0_ready;                                   // Led_R_s1_agent:cp_ready -> Led_R_s1_burst_adapter:source0_ready
	wire    [7:0] led_r_s1_burst_adapter_source0_channel;                                 // Led_R_s1_burst_adapter:source0_channel -> Led_R_s1_agent:cp_channel
	...
	wire          router_003_src_valid;                                                   // router_003:src_valid -> hex_display_s1_rsp_width_adapter:in_valid
	wire  [112:0] router_003_src_data;                                                    // router_003:src_data -> hex_display_s1_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                                   // hex_display_s1_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [7:0] router_003_src_channel;                                                 // router_003:src_channel -> hex_display_s1_rsp_width_adapter:in_channel
	wire          router_003_src_startofpacket;                                           // router_003:src_startofpacket -> hex_display_s1_rsp_width_adapter:in_startofpacket
	wire          router_003_src_endofpacket;                                             // router_003:src_endofpacket -> hex_display_s1_rsp_width_adapter:in_endofpacket
	wire          hex_display_s1_rsp_width_adapter_src_valid;                             // hex_display_s1_rsp_width_adapter:out_valid -> rsp_demux_002:sink_valid
	wire  [148:0] hex_display_s1_rsp_width_adapter_src_data;                              // hex_display_s1_rsp_width_adapter:out_data -> rsp_demux_002:sink_data
	wire          hex_display_s1_rsp_width_adapter_src_ready;                             // rsp_demux_002:sink_ready -> hex_display_s1_rsp_width_adapter:out_ready
	wire    [7:0] hex_display_s1_rsp_width_adapter_src_channel;                           // hex_display_s1_rsp_width_adapter:out_channel -> rsp_demux_002:sink_channel
	wire          hex_display_s1_rsp_width_adapter_src_startofpacket;                     // hex_display_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_002:sink_startofpacket
	wire          hex_display_s1_rsp_width_adapter_src_endofpacket;                       // hex_display_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_002:sink_endofpacket
	wire          router_004_src_valid;                                                   // router_004:src_valid -> buttons_s1_rsp_width_adapter:in_valid
	wire  [112:0] router_004_src_data;                                                    // router_004:src_data -> buttons_s1_rsp_width_adapter:in_data
	wire          router_004_src_ready;                                                   // buttons_s1_rsp_width_adapter:in_ready -> router_004:src_ready
	wire    [7:0] router_004_src_channel;                                                 // router_004:src_channel -> buttons_s1_rsp_width_adapter:in_channel
	wire          router_004_src_startofpacket;                                           // router_004:src_startofpacket -> buttons_s1_rsp_width_adapter:in_startofpacket
	wire          router_004_src_endofpacket;                                             // router_004:src_endofpacket -> buttons_s1_rsp_width_adapter:in_endofpacket
	wire          buttons_s1_rsp_width_adapter_src_valid;                                 // buttons_s1_rsp_width_adapter:out_valid -> rsp_demux_003:sink_valid
	wire  [148:0] buttons_s1_rsp_width_adapter_src_data;                                  // buttons_s1_rsp_width_adapter:out_data -> rsp_demux_003:sink_data
	wire          buttons_s1_rsp_width_adapter_src_ready;                                 // rsp_demux_003:sink_ready -> buttons_s1_rsp_width_adapter:out_ready
	wire    [7:0] buttons_s1_rsp_width_adapter_src_channel;                               // buttons_s1_rsp_width_adapter:out_channel -> rsp_demux_003:sink_channel
	wire          buttons_s1_rsp_width_adapter_src_startofpacket;                         // buttons_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_003:sink_startofpacket
	wire          buttons_s1_rsp_width_adapter_src_endofpacket;                           // buttons_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_003:sink_endofpacket
	wire          router_005_src_valid;                                                   // router_005:src_valid -> Led_G_s1_rsp_width_adapter:in_valid
	wire  [112:0] router_005_src_data;                                                    // router_005:src_data -> Led_G_s1_rsp_width_adapter:in_data
	wire          router_005_src_ready;                                                   // Led_G_s1_rsp_width_adapter:in_ready -> router_005:src_ready
	wire    [7:0] router_005_src_channel;                                                 // router_005:src_channel -> Led_G_s1_rsp_width_adapter:in_channel
	...
	wire  [148:0] led_g_s1_rsp_width_adapter_src_data;                                    // Led_G_s1_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	wire          led_g_s1_rsp_width_adapter_src_ready;                                   // rsp_demux_004:sink_ready -> Led_G_s1_rsp_width_adapter:out_ready
	wire    [7:0] led_g_s1_rsp_width_adapter_src_channel;                                 // Led_G_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	...
	wire  [112:0] router_006_src_data;                                                    // router_006:src_data -> Led_R_s1_rsp_width_adapter:in_data
	wire          router_006_src_ready;                                                   // Led_R_s1_rsp_width_adapter:in_ready -> router_006:src_ready
	wire    [7:0] router_006_src_channel;                                                 // router_006:src_channel -> Led_R_s1_rsp_width_adapter:in_channel
	...
	wire  [148:0] led_r_s1_rsp_width_adapter_src_data;                                    // Led_R_s1_rsp_width_adapter:out_data -> rsp_demux_005:sink_data
	wire          led_r_s1_rsp_width_adapter_src_ready;                                   // rsp_demux_005:sink_ready -> Led_R_s1_rsp_width_adapter:out_ready
	wire    [7:0] led_r_s1_rsp_width_adapter_src_channel;                                 // Led_R_s1_rsp_width_adapter:out_channel -> rsp_demux_005:sink_channel
	...
	wire          router_007_src_valid;                                                   // router_007:src_valid -> hexport_s1_rsp_width_adapter:in_valid
	wire  [112:0] router_007_src_data;                                                    // router_007:src_data -> hexport_s1_rsp_width_adapter:in_data
	wire          router_007_src_ready;                                                   // hexport_s1_rsp_width_adapter:in_ready -> router_007:src_ready
	wire    [7:0] router_007_src_channel;                                                 // router_007:src_channel -> hexport_s1_rsp_width_adapter:in_channel
	wire          router_007_src_startofpacket;                                           // router_007:src_startofpacket -> hexport_s1_rsp_width_adapter:in_startofpacket
	wire          router_007_src_endofpacket;                                             // router_007:src_endofpacket -> hexport_s1_rsp_width_adapter:in_endofpacket
	wire          hexport_s1_rsp_width_adapter_src_valid;                                 // hexport_s1_rsp_width_adapter:out_valid -> rsp_demux_006:sink_valid
	wire  [148:0] hexport_s1_rsp_width_adapter_src_data;                                  // hexport_s1_rsp_width_adapter:out_data -> rsp_demux_006:sink_data
	wire          hexport_s1_rsp_width_adapter_src_ready;                                 // rsp_demux_006:sink_ready -> hexport_s1_rsp_width_adapter:out_ready
	wire    [7:0] hexport_s1_rsp_width_adapter_src_channel;                               // hexport_s1_rsp_width_adapter:out_channel -> rsp_demux_006:sink_channel
	wire          hexport_s1_rsp_width_adapter_src_startofpacket;                         // hexport_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_006:sink_startofpacket
	wire          hexport_s1_rsp_width_adapter_src_endofpacket;                           // hexport_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_006:sink_endofpacket
	...
	wire          cmd_mux_002_src_valid;                                                  // cmd_mux_002:src_valid -> hex_display_s1_cmd_width_adapter:in_valid
	wire  [148:0] cmd_mux_002_src_data;                                                   // cmd_mux_002:src_data -> hex_display_s1_cmd_width_adapter:in_data
	wire          cmd_mux_002_src_ready;                                                  // hex_display_s1_cmd_width_adapter:in_ready -> cmd_mux_002:src_ready
	wire    [7:0] cmd_mux_002_src_channel;                                                // cmd_mux_002:src_channel -> hex_display_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_002_src_startofpacket;                                          // cmd_mux_002:src_startofpacket -> hex_display_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                            // cmd_mux_002:src_endofpacket -> hex_display_s1_cmd_width_adapter:in_endofpacket
	...
	wire          cmd_mux_003_src_valid;                                                  // cmd_mux_003:src_valid -> buttons_s1_cmd_width_adapter:in_valid
	wire  [148:0] cmd_mux_003_src_data;                                                   // cmd_mux_003:src_data -> buttons_s1_cmd_width_adapter:in_data
	wire          cmd_mux_003_src_ready;                                                  // buttons_s1_cmd_width_adapter:in_ready -> cmd_mux_003:src_ready
	wire    [7:0] cmd_mux_003_src_channel;                                                // cmd_mux_003:src_channel -> buttons_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_003_src_startofpacket;                                          // cmd_mux_003:src_startofpacket -> buttons_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                            // cmd_mux_003:src_endofpacket -> buttons_s1_cmd_width_adapter:in_endofpacket
	...
	wire  [148:0] cmd_mux_004_src_data;                                                   // cmd_mux_004:src_data -> Led_G_s1_cmd_width_adapter:in_data
	wire          cmd_mux_004_src_ready;                                                  // Led_G_s1_cmd_width_adapter:in_ready -> cmd_mux_004:src_ready
	wire    [7:0] cmd_mux_004_src_channel;                                                // cmd_mux_004:src_channel -> Led_G_s1_cmd_width_adapter:in_channel
	...
	wire  [112:0] led_g_s1_cmd_width_adapter_src_data;                                    // Led_G_s1_cmd_width_adapter:out_data -> Led_G_s1_burst_adapter:sink0_data
	wire          led_g_s1_cmd_width_adapter_src_ready;                                   // Led_G_s1_burst_adapter:sink0_ready -> Led_G_s1_cmd_width_adapter:out_ready
	wire    [7:0] led_g_s1_cmd_width_adapter_src_channel;                                 // Led_G_s1_cmd_width_adapter:out_channel -> Led_G_s1_burst_adapter:sink0_channel
	...
	wire  [148:0] cmd_mux_005_src_data;                                                   // cmd_mux_005:src_data -> Led_R_s1_cmd_width_adapter:in_data
	wire          cmd_mux_005_src_ready;                                                  // Led_R_s1_cmd_width_adapter:in_ready -> cmd_mux_005:src_ready
	wire    [7:0] cmd_mux_005_src_channel;                                                // cmd_mux_005:src_channel -> Led_R_s1_cmd_width_adapter:in_channel
	...
	wire  [112:0] led_r_s1_cmd_width_adapter_src_data;                                    // Led_R_s1_cmd_width_adapter:out_data -> Led_R_s1_burst_adapter:sink0_data
	wire          led_r_s1_cmd_width_adapter_src_ready;                                   // Led_R_s1_burst_adapter:sink0_ready -> Led_R_s1_cmd_width_adapter:out_ready
	wire    [7:0] led_r_s1_cmd_width_adapter_src_channel;                                 // Led_R_s1_cmd_width_adapter:out_channel -> Led_R_s1_burst_adapter:sink0_channel
	...
	wire          cmd_mux_006_src_valid;                                                  // cmd_mux_006:src_valid -> hexport_s1_cmd_width_adapter:in_valid
	wire  [148:0] cmd_mux_006_src_data;                                                   // cmd_mux_006:src_data -> hexport_s1_cmd_width_adapter:in_data
	wire          cmd_mux_006_src_ready;                                                  // hexport_s1_cmd_width_adapter:in_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                                // cmd_mux_006:src_channel -> hexport_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_006_src_startofpacket;                                          // cmd_mux_006:src_startofpacket -> hexport_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                            // cmd_mux_006:src_endofpacket -> hexport_s1_cmd_width_adapter:in_endofpacket
	...
	wire          hex_display_s1_agent_rdata_fifo_src_valid;                              // hex_display_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] hex_display_s1_agent_rdata_fifo_src_data;                               // hex_display_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire          hex_display_s1_agent_rdata_fifo_src_ready;                              // avalon_st_adapter_002:in_0_ready -> hex_display_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_002_out_0_valid;                                      // avalon_st_adapter_002:out_0_valid -> hex_display_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                       // avalon_st_adapter_002:out_0_data -> hex_display_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                      // hex_display_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                      // avalon_st_adapter_002:out_0_error -> hex_display_s1_agent:rdata_fifo_sink_error
	...
	wire          hexport_s1_agent_rdata_fifo_src_valid;                                  // hexport_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] hexport_s1_agent_rdata_fifo_src_data;                                   // hexport_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          hexport_s1_agent_rdata_fifo_src_ready;                                  // avalon_st_adapter_006:in_0_ready -> hexport_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                      // avalon_st_adapter_006:out_0_valid -> hexport_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                       // avalon_st_adapter_006:out_0_data -> hexport_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                      // hexport_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                      // avalon_st_adapter_006:out_0_error -> hexport_s1_agent:rdata_fifo_sink_error
